...
class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine("Tab: ");
        var tab = RandTab(8, 1, 99);
        PrintTab(tab);

        Console.WriteLine("Bubble sort: ");
        var tabBS = (int[])tab.Clone();
        BubbleSort(tabBS);
        PrintTab(tabBS);

        Console.WriteLine("Insert sort: ");
        var tabIS = (int[])tab.Clone();
        InsertSort(tabIS);
        PrintTab(tabIS);

        Console.WriteLine("Quick sort: ");
        var tabQS = (int[])tab.Clone();
        QuickSort(tabQS, 0, tab.Length - 1);
        PrintTab(tabQS);

        Console.WriteLine("Merge sort: ");
        var tabMS = (int[])tab.Clone();
        MergeSort(tabMS, 0, tab.Length - 1);
        PrintTab(tabMS);

        Console.WriteLine("Counting sort: ");
        var tabCS = (int[])tab.Clone();
        CountingSort(tabCS);
        PrintTab(tabCS);
    }
}